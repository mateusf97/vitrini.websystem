	...
	<div class="row text-center top-space">
		<div class="columns small-12 top-space">
			<div class="row text-left top-space">
				...
				<div class="columns small-12 medium-4">
					<div class="input-data-container">
						<input autocomplete="off" class="input-data" type="tel" id="usuario-telefone">
					</div>
				</div>
				...
				<div class="columns small-12 medium-4">
					<div class="input-data-container">
						<input autocomplete="off" required class="input-data" type="tel" id="usuario-telefone-celular">
					</div>
				</div>
...
$(document).ready(function() {
  ...
  $("form").submit(function(e){
      ...
      $("#user-register :input").each(function(){
		  ...
		  $.ajax({
		    ...
		    success: function(json) {
		      ...
		      //setTimeout(function(){ $this.html('<i class="fa fa-check"></i>'); }, 2000);
		    }
		  });
	...
	$('#rg, #conjuge-rg, #telefone, #telefone-aluguel, #telefone-celular').on('blur',function(){
		var txt = $(this).val();
	...
	$('#usuario-cpf, #conjuge-cpf').on('blur',function(){
		var txt = $(this).val();
